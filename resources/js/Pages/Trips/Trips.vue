<template>
  <div>
    ...
    <div class="border rounded-xl overflow-hidden mt-5">
      <table class="shadow-md w-full text-sm text-left text-gray-500">
        ...
        <tbody>
          ...
          >
            ...
            <td class="pl-1">
              <span
                class="text-2xl cursor-pointer text-green-600 inline-block hover:scale-110"
                @click="Inertia.get(route('trips.edit', trip.id))"
              ><i class="fas fa-calendar-edit" /></span>
              <span
                class="pl-3 text-2xl inline-block cursor-pointer text-red-600 hover:scale-110"
